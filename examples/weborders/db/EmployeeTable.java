...
import examples.weborders.source.Employee;
...
public class EmployeeTable {
    ...
    public static void setZip(Employee instance, examples.weborders.source.Zipcode val) {
        instance.zip = val;
    }
    ...
    public static Stream<Employee> queryZip(examples.weborders.source.Zipcode val) {
    ...
    queryEnoZip(Integer eno, examples.weborders.source.Zipcode zip) {
    ...
    public static Stream<Employee>
    queryDateZip(java.lang.String date, examples.weborders.source.Zipcode zip) {
        Iterable<Employee> seed = table;
        int size = table.size();
    ...
    public static Stream<Employee>
    queryDateEnoZip(java.lang.String date, Integer eno, examples.weborders.source.Zipcode zip) {
        Iterable<Employee> seed = table;
        int size = table.size();
    ...
    public static Stream<Employee>
    queryEnameZip(java.lang.String ename, examples.weborders.source.Zipcode zip) {
        Iterable<Employee> seed = table;
        int size = table.size();
    ...
    public static Stream<Employee>
    queryEnameEnoZip(java.lang.String ename, Integer eno, examples.weborders.source.Zipcode zip) {
        Iterable<Employee> seed = table;
        int size = table.size();
    ...
    public static Stream<Employee>
    queryDateEnameZip(java.lang.String date, java.lang.String ename, examples.weborders.source.Zipcode zip) {
        Iterable<Employee> seed = table;
        int size = table.size();
    ...
    public static Stream<Employee>
    queryDateEnameEnoZip(java.lang.String date, java.lang.String ename, Integer eno, examples.weborders.source.Zipcode zip) {
        Iterable<Employee> seed = table;
        int size = table.size();
