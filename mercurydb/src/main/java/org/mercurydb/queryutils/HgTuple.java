...
public class HgTuple extends HashMap<Class<?>, Object> {
    ...
    public HgTuple(HgTupleStream s1, final Object o1, HgTupleStream s2, final Object o2) {
    ...
    public static HgTuple makeRecord(HgTupleStream s, Object o) {
        HgTuple jr;
    ...
    public static HgTuple singleton(HgTupleStream s, Object o) {
