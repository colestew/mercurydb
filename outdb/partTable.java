...
public class partTable {
    public static Set<part> table = new HashSet<>();
        //Collections.newSetFromMap(new WeakHashMap<part, Boolean>());
    ...
    public static Stream<part> scan() {
        return new Retrieval<part>(table, table.size());
    }
}
